...
class Agent:
    ...
    def get_state(self, game):
        ...
        state = [
                # Danger straight
                (dir_r and game.is_collision1(point_r,point_r2)) or 
                (dir_l and game.is_collision1(point_l,point_l2)) or 
                (dir_u and game.is_collision1(point_u,point_u2)) or 
                (dir_d and game.is_collision1(point_d,point_d2)),

                # Danger right
                (dir_u and game.is_collision1(point_r,point_r2)) or 
                (dir_d and game.is_collision1(point_l,point_l2)) or 
                (dir_l and game.is_collision1(point_u,point_u2)) or 
                (dir_r and game.is_collision1(point_d,point_d2)),

                # Danger left
                (dir_d and game.is_collision1(point_r,point_r2)) or 
                (dir_u and game.is_collision1(point_l,point_l2)) or 
                (dir_r and game.is_collision1(point_u,point_u2)) or 
                (dir_l and game.is_collision1(point_d,point_d2)),
...
class Agent2:
    ...
    def get_state(self, game):
        ...
        state = [
                # Danger straight
                (dir_r2 and game.is_collision2(point_r,point_r2)) or 
                (dir_l2 and game.is_collision2(point_l,point_l2)) or 
                (dir_u2 and game.is_collision2(point_u,point_u2)) or 
                (dir_d2 and game.is_collision2(point_d,point_d2)),

                # Danger right
                (dir_u2 and game.is_collision2(point_r,point_r2)) or 
                (dir_d2 and game.is_collision2(point_l,point_l2)) or 
                (dir_l2 and game.is_collision2(point_u,point_u2)) or 
                (dir_r2 and game.is_collision2(point_d,point_d2)),

                # Danger left
                (dir_d2 and game.is_collision2(point_r,point_r2)) or 
                (dir_u2 and game.is_collision2(point_l,point_l2)) or 
                (dir_r2 and game.is_collision2(point_u,point_u2)) or 
                (dir_l2 and game.is_collision2(point_d,point_d2)),
...
def train():
    ...
    while True:
        ...
        reward, done, score, reward2, done2, score2 = game.play_step(final_move,final_move2)
        ...
        if done and done2:
            ...
            plot_mean_scores.append(mean_score)
            if( agent2.n_games==0):
                plot1(plot_scores, plot_mean_scores)
            else: 
                mean_score2 = total_score2 / agent2.n_games
                plot_mean_scores2.append(mean_score2)
                plot(plot_scores, plot_mean_scores, plot_scores2, plot_mean_scores2)
            ...
            plot_mean_scores2.append(mean_score2)
            if( agent.n_games==0):
                plot2(plot_scores2, plot_mean_scores2)
            else:
                mean_score = total_score / agent.n_games
                plot_mean_scores.append(mean_score)
                plot(plot_scores, plot_mean_scores, plot_scores2, plot_mean_scores2)
